...
i.app.post('/insertsuspect',(req,res,next)=>{
    ...
    check = i.checkparams.check(req.body,shouldhave,allcols,[])
    if(check.result){
...
i.app.post('/proposesurvey',(req,res)=>{
    ...
    var pars = req.body
    check = i.checkparams.check(req.body,shouldhave,allcols,['client_id'])
    if(check.result){
...
i.app.post('/proposeinstall',(req,res)=>{
    ...
    var pars = req.body
    check = i.checkparams.check(req.body,shouldhave,allcols,['client_id','client_site_id'])
    if(check.result){
